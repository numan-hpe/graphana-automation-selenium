...
PIN = "your_SSO_PIN" # [Optional] Uncomment L92-94 in graphana_selenium.py for auto PIN entry 
BOT_TOKEN = "Add token here" # [Optional]
CHANNEL_ID = "C085P82Q4R4" # [Optional]
REGION_DATA = {
    "ccprodusw2": "https://ccprodusw2-us-west-2.cloudops.compute.cloud.hpe.com/tenant-monitoring/d/cedf5bb7-b9cb-4e66-8de8-454539bc24b1/telemetry-data-pipeline-monitoring?orgId=1&from=now-24h&to=now",
