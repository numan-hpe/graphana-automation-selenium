...
REGION_DATA = {
    ...
    # "ccprodeuc1": "https://ccprodeuc1-eu-central-1.cloudops.compute.cloud.hpe.com/tenant-monitoring/d/cedf5bb7-b9cb-4e66-8de8-454539bc24b1/telemetry-data-pipeline-monitoring?orgId=1&from=now-24h&to=now&" + get_services_string("ccprodeuc1"),
    # "ccprodane1": "https://ccprodane1-ap-northeast-1.cloudops.compute.cloud.hpe.com/tenant-monitoring/d/cedf5bb7-b9cb-4e66-8de8-454539bc24b1/telemetry-data-pipeline-monitoring?orgId=1&from=now-24h&to=now&" + get_services_string("ccprodane1"),
    # "pre-prod": "https://ccpreusw2-us-west-2.cloudops.compute.cloud.hpe.com/tenant-monitoring/d/cedf5bb7-b9cb-4e66-8de8-454539bc24b1/telemetry-data-pipeline-monitoring?orgId=1&from=now-24h&to=now&" + get_services_string("pre-prod"),
}
HUMIO_DATA = {
...
HEADINGS = {
    "opt_in": "Opted-In devices in last 24hrs",
    # "spark_running_count": "Spark app executor running count",
